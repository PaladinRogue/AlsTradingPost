...
namespace PaladinRogue.Authentication.Persistence.Migrations
{
    ...
    partial class MoveEmailAddressToPasswordIdentity
    {
            ...
            modelBuilder.Entity("PaladinRogue.Authentication.Domain.Identities.RefreshTokenIdentity", b =>
                {
                    ...
                    b.OwnsOne("PaladinRogue.Library.Core.Domain.DataProtection.HashSet", "RefreshTokenHash", b1 =>
                        {
                            ...
                            b1.HasOne("PaladinRogue.Authentication.Domain.Identities.RefreshTokenIdentity")
                                .WithOne("RefreshTokenHash")
                                .HasForeignKey("PaladinRogue.Library.Core.Domain.DataProtection.HashSet", "RefreshTokenIdentityId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
