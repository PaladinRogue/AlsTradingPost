...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaladinRogue.Authentication.Domain.Identities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PaladinRogue.Authentication.Domain.Identities.RefreshToken", b =>
                {
                    ...
                    b.HasOne("PaladinRogue.Authentication.Domain.Identities.Session", "Session")
                        .WithOne("RefreshToken")
                        .HasForeignKey("PaladinRogue.Authentication.Domain.Identities.RefreshToken", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("PaladinRogue.Library.Core.Domain.DataProtection.HashSet", "TokenHash", b1 =>
                        {
                            ...
                            b1.HasOne("PaladinRogue.Authentication.Domain.Identities.RefreshToken")
                                .WithOne("TokenHash")
                                .HasForeignKey("PaladinRogue.Library.Core.Domain.DataProtection.HashSet", "RefreshTokenId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
