                    ...
                    b.OwnsOne("Authentication.Domain.Identities.RefreshToken", "RefreshToken", b1 =>
                        {
                            ...
                            b1.OwnsOne("Core.Domain.DataProtectors.HashSet", "TokenHash", b2 =>
                                {
                                    ...
                                    b2.HasOne("Authentication.Domain.Identities.RefreshToken")
                                        .WithOne("TokenHash")
                                        .HasForeignKey("Core.Domain.DataProtectors.HashSet", "RefreshTokenSessionId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                        });
                });
            ...
            modelBuilder.Entity("Authentication.Domain.Identities.PasswordIdentity", b =>
                {
                    ...
                    b.OwnsOne("Core.Domain.DataProtectors.HashSet", "PasswordHash", b1 =>
                        {
                            ...
                            b1.HasOne("Authentication.Domain.Identities.PasswordIdentity")
                                ...
                                .HasForeignKey("Core.Domain.DataProtectors.HashSet", "PasswordIdentityId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
